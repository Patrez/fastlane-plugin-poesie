...
require 'fastlane/plugin/poesie/version'

Gem::Specification.new do |spec|
  spec.name          = 'fastlane-plugin-poesie'
  spec.version       = Fastlane::Poesie::VERSION
  spec.author        = 'Patrik Potoček'
  ...
  spec.add_dependency 'poesie', '~> 1.5.1'
